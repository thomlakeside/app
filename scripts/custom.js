...
$(document).ready(function(){      
	...
	function init_template(){
        ...
        var colorsArray = [
            ...
            ["niceblue","#62A8AC","#62A8AC","#62A8AC"],
            ["nicebluelight","#A1CCCE","#A1CCCE","#A1CCCE"],
            ["background","#F5F5F5","#F5F5F5","#F5F5F5"], 
            ["interested","#118fb0","#355070","#355070"],
            ["interestedlight","#EBF9FF","#D5DFEB","#D5DFEB"],
            ["rejected","#2fb5c7","#e56b6f","#e56b6f"],
            ["context","#024764","#11383D","#11383D"],
			...
			var call_charts_to_page = function(){
                ...
                if (verticalChart.length){
                    var verticalDemoChart = new Chart(verticalChart, {
                        type: 'bar',
                        data: {
                          labels: ["Position/company", "Location", "Not open to market"],
                          datasets: [
                            {
                              label: "Android",
                ...
                if(horizontalChart.length){
                    var horizontalDemoChart = new Chart(horizontalChart, {
                        type: 'horizontalBar',
                        data: {
                          labels: ["In progress", "Not interested", "Interested"],
                          datasets: [{
                              label: "Responsive",
